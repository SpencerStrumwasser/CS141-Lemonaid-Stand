...
questions = [ 
            [["pics/bg.png","pics/bghint.png", 4],["pics/farm2.png","pics/farm2hint.png", 240]],
            [["pics/cityblock.png","pics/cityblockhint.jpg", 5],["pics/school.jpg","pics/schoolhint.jpg", 8]],
            [["pics/cups2.png","pics/cups2hint.png", 1/15.],["pics/question6.jpg","pics/question6hint.jpg", 1./15]],
            [["pics/question7.jpg","pics/question7hint.jpg", 1/6.],["pics/question8.png","pics/question8hint.png", .198]],
            [["pics/brothers.png","pics/brothershint.png", 18],["pics/flowers.png","pics/flowershint.png", 120]]
            ]
...
def disp_end(cash):
    ...
    message_display('You earned ' + str(cash) + ' total dollars', blue, (300, 50))
        ...
        if not lemonadestand:
            ...
            for event in pg.event.get():
                ...
                if event.type == pg.MOUSEBUTTONDOWN and event.button == 1:
                    ...
                    if b.collidepoint(pos):
                        ...
                        hint += 1
                        hint = hint%2  
                        bg = pg.image.load(questions[x[i]][j][hint]).convert()
            ...
            if output != None:
                ...
                if output == questions[x[i]][j][2]:
                    ...
                    disp_failure()
                    f.write(str(x[i]) + str(j) + str(hint_used) + " Wrong\n")
                if j == 0:
                    j = 1
                    hint = 0
                    hint_used = 0
